...
function onCreate()
	...
	scaleObject('sky',2, 2);
	makeLuaSprite('what is this','Mira/pretender/front plant', -300, 0)
	scaleObject('what is this',2, 2);
	makeLuaSprite('front pot','Mira/pretender/front pot', -1300, 1250)
	...
	scaleObject('flowerguy', 2.24, 2.24);
