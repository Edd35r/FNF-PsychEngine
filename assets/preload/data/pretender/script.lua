...
function onCreate()
	...
	makeLuaSprite('Name','pretender', -500, 100)
	addLuaSprite('Name')
...
function onStepHit()
   ...
   if curStep == 1312 or curStep == 2452 or curStep == 9999 then
   flash()
   end
   if curStep == 1360 or curStep == 2452 or curStep == 288 or curStep == 800 then
   cuton()
   end
   if curStep == 1 or curStep == 2148 or curStep == 9999 or curStep == 544 or curStep == 1060 then
   cutoff()
   end
end
